...
_LAZY: dict[str, tuple[str, str | None]] = {
    ...
    "ActionStep": ("effgen.core.thread", "ActionStep"),
    "AgentThread": ("effgen.core.thread", "AgentThread"),
    "AnswerStep": ("effgen.core.thread", "AnswerStep"),
    "DelegationStep": ("effgen.core.thread", "DelegationStep"),
    "AudioPart": ("effgen.core.messages", "AudioPart"),
    "NudgeStep": ("effgen.core.thread", "NudgeStep"),
    "ObservationStep": ("effgen.core.thread", "ObservationStep"),
    "Step": ("effgen.core.thread", "Step"),
    "SystemStep": ("effgen.core.thread", "SystemStep"),
    "TaskStep": ("effgen.core.thread", "TaskStep"),
    "TurnStep": ("effgen.core.thread", "TurnStep"),
    "CompactionPolicy": ("effgen.core.thread_compaction", "CompactionPolicy"),
    "ShortenOldestFirst": ("effgen.core.thread_compaction", "ShortenOldestFirst"),
    "SummarizeWithModel": ("effgen.core.thread_compaction", "SummarizeWithModel"),
    "ThreadProjection": ("effgen.core.thread_projection", "ThreadProjection"),
    "NoParentContext": ("effgen.core.thread_projection", "NoParentContext"),
...
__all__ = [
    ...
    "KeepFirstAndLast",
    "KeepToolResults",
    # A run's conversation as typed steps, renderable as text or as messages
    "AgentThread",
    "Step",
    "SystemStep",
    "TaskStep",
