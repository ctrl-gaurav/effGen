...
A run sends fewer prompt tokens and makes fewer model calls; it is not faster, and it cost accuracy on
some sets. The figures are under "What it cost" at the end of this entry.
